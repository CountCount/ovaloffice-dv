...
// cit
$residents = $basic = $hero = $scout = $scavenger = $tamer = $guardian = $hunter = $banned = $dead = $tech = $shaman = 0;
$cit = array();
...
//bank
$def = $food = $water = $well = $jerry = $drugs = $alcohol = $coffe = 0;
$dfa = array();
...
<div class="spy-box" id="spy-cit">
	...
	<table border="0">
	<tr><td><?php print '<img src="'.t('GAMESERVER_SMILEY').'h_human.gif" /></td><td class="tr">'.$residents.'</td><td> '.t('RESIDENT'); ?></td></tr>
	<tr><td><?php print '<img src="'.t('GAMESERVER_SMILEY').'h_basic.gif" /></td><td class="tr">'.$basic.'</td><td> '.t('CITIZEN'); ?></td></tr>
	<tr><td><?php print '<img src="'.t('GAMESERVER_ICON').'r_heroac.gif" /></td><td class="tr">'.$hero.'</td><td> '.t('HEROS'); ?></td></tr>
	<tr><td><?php print '<img src="'.t('GAMESERVER_ICON').'r_jrangr.gif" /></td><td class="tr">'.$scout.'</td><td> '.t('SCOUT'); ?></td></tr>
	<tr><td><?php print '<img src="'.t('GAMESERVER_ICON').'r_jcolle.gif" /></td><td class="tr">'.$scavenger.'</td><td> '.t('SCAVENGER'); ?></td></tr>
	<tr><td><?php print '<img src="'.t('GAMESERVER_ICON').'r_jermit.gif" /></td><td class="tr">'.$hunter.'</td><td> '.t('HUNTER'); ?></td></tr>
	<tr><td><?php print '<img src="'.t('GAMESERVER_ICON').'r_jguard.gif" /></td><td class="tr">'.$guardian.'</td><td> '.t('GUARDIAN'); ?></td></tr>
	<tr><td><?php print '<img src="'.t('GAMESERVER_ICON').'r_jtamer.gif" /></td><td class="tr">'.$tamer.'</td><td> '.t('TAMER'); ?></td></tr>
	<tr><td><?php print '<img src="'.t('GAMESERVER_ICON').'r_jtech.gif" /></td><td class="tr">'.$tech.'</td><td> '.t('TECH'); ?></td></tr>
	<tr><td><?php print '<img src="'.t('GAMESERVER_ICON').'r_jsham.gif" /></td><td class="tr">'.$shaman.'</td><td> '.t('SHAMAN'); ?></td></tr>
	<tr><td><?php print '<img src="'.t('GAMESERVER_SMILEY').'h_ban.gif" /></td><td class="tr">'.$banned.'</td><td> '.t('BANNED'); ?></td></tr>
	...
	<table border="0">
		<?php foreach ( $cit AS $c ) { 
			switch ($c['job']) {
				...
				default: $ci = t('GAMESERVER_SMILEY').'h_basic.gif'; break;
			}
...
$piwikTracker->setURL('http://dv.sindevel.com/oo/stat.spyt.ajax.php');
$piwikTracker->setCustomVariable(1, 'spytown', $t."|".$d);
$piwikTracker->setCustomVariable(2, 'ip', $_SERVER['REMOTE_ADDR']);
$piwikTracker->setCustomVariable(3, 'query', $_SERVER['QUERY_STRING']);
// Sends Tracker request via http
$piwikTracker->doTrackPageView('OO SpyOnTown');