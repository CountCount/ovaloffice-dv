...
$piwikTracker->setURL('http://dv.sindevel.com/oo/mailbox.message.php');
...
switch ($a) {
	...
	case 'send':
	{
		...
		// ok, send msg
		$q = ' INSERT INTO dvoo_fl_mailbox VALUES (NULL, '.$aid.', '.$bid.', "'.mysql_real_escape_string(trim(strip_tags($_POST['msg-subject']))).'", "'.mysql_real_escape_string(trim(strip_tags($_POST['msg-body']))).'", '.time().', NULL, NULL) ';
		$db->iquery($q);
